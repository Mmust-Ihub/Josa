          ...
          >
            <ul className="flex flex-col font-medium p-4 md:p-0 mt-4   md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0  ">
              ...
              <li className="relative">
                {" "}
                {/* Set the parent element as relative */}
                <button
                  onClick={() =>
                ...
                {isCategoriesDropdownOpen && (
                  <div
                    id="dropdownNavbar"
                    className="absolute left-0 top-full z-10 mt-2 font-normal bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600"
                  >
